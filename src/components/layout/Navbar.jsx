                ...
                <div className="flex items-center">
                 ...
                 <Link to="/" className="hover:text-blue-400">Contact</Link>
                  ...
                  <div className=" hidden gap-5 md:flex items-center  space-x-4">
                    <Link to="/login">
                        <Button className="text-gray-500  border border-blue-300 py-2 px-4 rounded-3xl  cursor-pointer">Log In</Button>
                      </Link>
                      <Link to="/register">
                        <Button  className="text-white bg-blue-500 py-3 px-4 rounded-3xl cursor-pointer ">Apply Now</Button>
                      </Link>
                  </div> 
