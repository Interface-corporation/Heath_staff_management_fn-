    ...
    <div className="max-w-5xl mx-auto p-6 ">
        ...
        <div className="mb-6">
          ...
          <div className="space-y-2">
            {["Day", "Evening", "Night", "Weekends", "Every other weekend"].map((schedule) => (
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500 mb-2">Share any relevant information with us.</p>
          <textarea
            id="message"
            rows="4"
        ...
        <div className="mb-6">
          ...
          <div  className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:bg-gray-50 transition-colors">
            ...
            >
              <p className="text-gray-600"><span className="text-blue-600">Choose file </span> or drop here</p>
              {resume && (
