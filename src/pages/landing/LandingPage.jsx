    ...
    <section className="relative top-[70px] bg-gradient-to-br from-[#00A2E8] to-[#5FB3B3] text-white">
      <Container className=" px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center pb-24">
            <div className="space-y-6">
              ...
              <p className="text-xl text-white/90 max-w-lg">
                Streamlining the process of matching qualified healthcare professionals with healthcare facilities in need.
              </p>
        ...
        <div className="w-full absolute left-0 right-0 bottom-0">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 100" className="w-full h-auto -mb-1">
              <path fill="#ffffff" fillOpacity="1" d="M0,32L80,42.7C160,53,320,75,480,69.3C640,64,800,32,960,21.3C1120,11,1280,21,1360,26.7L1440,32L1440,100L1360,100C1280,100,1120,100,960,100C800,100,640,100,480,100C320,100,160,100,80,100L0,100Z"></path>
            </svg>
         </div>
      ...
      <section className="bg-[#00A2E8] py-16 mt-18">
        <Container className=" px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="text-3xl font-bold text-white mb-4">Ready to Advance Your Healthcare Career?</h2>
              <p className="text-xl text-white/90 mb-8">
                Join thousands of healthcare professionals on our platform and discover new opportunities.
              </p>
              <Link to="/register">
                  <Button className= " flex bg-white hover:bg-white text-[#00A2E8] py-2 px-6 rounded-xl cursor-pointer">
                    Apply Now <ArrowRight size={20} className="pl-2  pt-1" />
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-white font-semibold text-lg">Verified Facilities</h3>
                  <p className="text-white/80">All healthcare facilities on our platform undergo a thorough verification process.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                <CheckCircle className="text-white mr-3 flex-shrink-0 mt-1" />
                <div>
                  <h3 className="text-white font-semibold text-lg">Transparent Process</h3>
                  <p className="text-white/80">Our platform provides full transparency throughout the application and matching process.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-white/80">Our dedicated support team is available to assist you at every step of your journey.</p>
                </div>
              </div>
            </div>
          </div>
